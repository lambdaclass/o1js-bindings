...
export function caml_bn254_fp_plonk_index_serialize_srs(a: number, b: number): void;
...
export function __wbg_wasmbn254fppairingproof_free(a: number): void;
export function wasmbn254fppairingproof_new(a: number, b: number, c: number): number;
export function wasmbn254fppairingproof_quotient(a: number): number;
export function wasmbn254fppairingproof_set_quotient(a: number, b: number): void;
...
export function __wbg_get_wasmbn254fppairingproof_blinding(a: number, b: number): void;
...
export function __wbg_set_wasmbn254fppairingproof_blinding(a: number, b: number, c: number): void;
