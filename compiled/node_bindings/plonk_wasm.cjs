...
*/
module.exports.caml_bn254_fp_srs_create = function (_depth) {
    const ret = wasm.caml_bn254_fp_srs_create(_depth);
...
* @returns {string}
*/
module.exports.caml_bn254_fp_plonk_index_serialize_srs = function (index) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(index, WasmBn254FpPlonkIndex);
        wasm.caml_bn254_fp_plonk_index_serialize_srs(retptr, index.__wbg_ptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred1_0 = r0;
        deferred1_1 = r1;
...
/**
*/
class WasmBn254FpPairingProof {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmBn254FpPairingProof.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmbn254fppairingproof_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    ...
    */
    ...
    /**
    * @param {WasmGBn254} quotient
    * @param {Uint8Array} blinding
    */
    constructor(quotient, blinding) {
        _assertClass(quotient, WasmGBn254);
        var ptr0 = quotient.__destroy_into_raw();
        const ptr1 = passArray8ToWasm0(blinding, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmbn254fppairingproof_new(ptr0, ptr1, len1);
        return WasmBn254FpPairingProof.__wrap(ret);
    }
    /**
    * @returns {WasmGBn254}
    */
    get quotient() {
        const ret = wasm.wasmbn254fppairingproof_quotient(this.__wbg_ptr);
        return WasmGBn254.__wrap(ret);
    }
    /**
    * @param {WasmGBn254} quotient
    */
    set quotient(quotient) {
        _assertClass(quotient, WasmGBn254);
        var ptr0 = quotient.__destroy_into_raw();
        wasm.wasmbn254fppairingproof_set_quotient(this.__wbg_ptr, ptr0);
    }
}
module.exports.WasmBn254FpPairingProof = WasmBn254FpPairingProof;
/**
...
module.exports.__wbg_log_003c998d6df63565 = function (arg0) {
...
module.exports.__wbg_call_35782e9a1aa5e091 = function () {
