...
*/
export function caml_bn254_fp_srs_create(_depth: number): WasmBn254FpSrs;
/**
...
* @returns {string}
*/
export function caml_bn254_fp_plonk_index_serialize_srs(index: WasmBn254FpPlonkIndex): string;
/**
...
/**
*/
export class WasmBn254FpPairingProof {
  free(): void;
/**
* @param {WasmGBn254} quotient
* @param {Uint8Array} blinding
*/
  constructor(quotient: WasmGBn254, blinding: Uint8Array);
/**
*/
  blinding: Uint8Array;
/**
...
export interface InitOutput {
  ...
  readonly caml_bn254_fp_plonk_index_serialize_srs: (a: number, b: number) => void;
  ...
  readonly __wbg_wasmbn254fppairingproof_free: (a: number) => void;
  readonly wasmbn254fppairingproof_new: (a: number, b: number, c: number) => number;
  readonly wasmbn254fppairingproof_quotient: (a: number) => number;
  readonly wasmbn254fppairingproof_set_quotient: (a: number, b: number) => void;
  ...
  readonly __wbg_get_wasmbn254fppairingproof_blinding: (a: number, b: number) => void;
  ...
  readonly __wbg_set_wasmbn254fppairingproof_blinding: (a: number, b: number, c: number) => void;
